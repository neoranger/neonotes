...
- **Editor Markdown Completo**: Vista previa en vivo (Split view), resaltado de sintaxis, tablas, listas de tareas, citas y exportación a archivos `.md`.
...
### Configuración del secreto JWT (obligatorio en producción)
